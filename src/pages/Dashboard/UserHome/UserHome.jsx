...
const UserHome = () => {
    ...
    return (
        <div className="bg-white pt-10 text-black">
            <div className="w-4/5 mx-auto">
                <h2 className="uppercase text-2xl bold" id="rateUs">hi, welcome back!</h2>
                <div className="grid grid-cols-3 gap-4 justify-center mt-5 max-md:grid-cols-2 max-sm:grid-cols-1">
                    <div className="menu-part text-white w-full py-5 flex justify-center items-center rounded-xl">
                    ...
                    <div className="shop-part text-white w-full py-5 flex justify-center items-center rounded-xl">
                    ...
                    <div className="contact-part text-white w-full py-5 flex justify-center items-center rounded-xl">
                ...
                <div className="grid grid-cols-2 items-center justify-center my-10 max-md:grid-cols-1 bg-white">
                    <div className="user-info text-center w-full py-20 h-[350px]">
                        <img src={`${user.photoURL}`} alt="" className="inline-block mb-10 w-[27%] max-md:w-[48%]" />
                        <h2 id="rateUs" className="uppercase text-xl">{user.displayName}</h2>
                    </div>
                    <div className="user-activity w-full py-20 h-[350px] max-md:mt-5">
